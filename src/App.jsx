...
function App() {
  ...
  return (
    <div className="px-5 flex flex-col justify-center items-center min-h-screen font-inter">
    <section className="bg-hsl-12 w-full max-w-[375px] p-8 rounded-lg">
        <div className="flex flex-col items-center gap-y-6">
          ...
          <h3 className="text-hsl-green font-bold text-[13px]">London, United Kingdom</h3>
           </div>
